...
#
#              for k in range(r - s):      change to ((r - s) + 1)
#                  count = 0               should be placed before the loop
#                  if math.cos(r) > 0:     change to math.cos(r + k)
#                      count = 1           change to count = count + 1
#                  return count            remove indent
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean?     placeholder for value
#
